...
namespace Microsoft.CodeAnalysisP.UnitTests.Text
{
    public class SourceTextTests
    {
        ...
        // NOTE: For RoslynP this is the first 16 bytes of System.Messaging.dll, replacing the use of TestResources.NetFX.v4_0_30319.System in Roslyn.
        private static readonly byte[] s_binaryTestResource = { 0x4d, 0x5a, 0x90, 0x00, 0x03, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0xff, 0xff, 0x00, 0x00 };
        ...
        public void IsBinary()
        {
            ...
            Assert.True(SourceText.IsBinary(encoding.GetString(s_binaryTestResource)));
        }

        [Fact]
        public void FromThrowsIfBinary()
        {
            var bytes = s_binaryTestResource;
